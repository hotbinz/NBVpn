...
package com.github.nbvpn.database
...
import com.github.nbvpn.utils.parsePort
...
class Profile : Serializable {
    ...
    @DatabaseField
    var host: String = "47.89.9.190"

    @DatabaseField
    var remotePort: Int = 8388

    @DatabaseField
    var password: String = "huobin"

    @DatabaseField
    var method: String = "aes-256-cfb"

    @DatabaseField
    var proxyType: String = "shadowsocks"
    ...
    fun serialize() {
        ...
        DataStore.privateStore.putString(Key.proxyType, proxyType)
    ...
    fun deserialize() {
        ...
        proxyType = DataStore.privateStore.getString(Key.proxyType) ?:""
